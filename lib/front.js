...
class Front {
  constructor() {
    ...
    // Which messages are the current ones is a question about the active item,
    // so the front end watches the workspace directly rather than asking the
    // hub to tell it.
    this.subscriptions.add(
      lumine.workspace.getCenter().observeActivePaneItem(() => this.setEditor()),
    );
  }
